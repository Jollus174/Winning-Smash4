...
`npm install gulp-sass browser-sync gulp-useref gulp-if gulp-cache gulp-uglify gulp-cssnano gulp-uncss gulp-imagemin gulp-cache del run-sequence gulp-jsonminify --save-dev`