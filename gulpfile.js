...
gulp.task('jsonminify', function () {
	return gulp.src('app/api/*.json').pipe(jsonminify()).pipe(gulp.dest('public/api'));
});
...
gulp.task('movemanifest', function () {
	return gulp.src('app/manifest.json').pipe(jsonminify()).pipe(gulp.dest('public'));
});
gulp.task('moveserviceworker', function () {
	return gulp.src('app/service-worker.js').pipe(gulp.dest('public'));
});
gulp.task('movereset', function () {
	return gulp.src('app/reset/*').pipe(gulp.dest('public/reset'));
});
//
